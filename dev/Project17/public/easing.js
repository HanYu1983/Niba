window.Easing = function () {
    ...
    // 彈簧進入效果 - 從靜止開始彈跳
    function springIn(t, tension = 0.4, friction = 0.6) {
        return customSpring(t, tension, friction);
    }

    // 彈簧退出效果 - 快速開始然後彈跳結束
    function springOut(t, tension = 0.4, friction = 0.6) {
        return 1 - customSpring(1 - t, tension, friction);
    }

    // 彈簧進入退出效果
    function springInOut(t, tension = 0.4, friction = 0.6) {
        if (t < 0.5) {
            return springIn(t * 2, tension, friction) * 0.5;
        }
        return 0.5 + springOut((t - 0.5) * 2, tension, friction) * 0.5;
    }
