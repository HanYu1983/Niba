...
import { DEFAULT_GAME_CONTEXT, GameContext } from "../tool/tool/basic/gameContext";
...
function test1() {
    ...
    ctx = {
        ...
        gameState: {
            ...
            // @ts-ignore
            timing: TIMING_CHART.find(t => t[1][0] == "戦闘フェイズ" && t[1][2] == "フリータイミング")
        }
    }
    ctx = initState(ctx)
