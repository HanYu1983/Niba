...
export const CONDITION_TOTAL_COST: Condition = {
  id: "ConditionCompareNumber",
  value: [
    {
      id: "數字",
...
export const CONDITION_PLAY_UNIT_FROM_BASYOU: Condition = {
  id: "ConditionCompareBaSyou",
  value: [
    {
      id: "場所",
...
export const REQUIRE_PLAY: RequireTarget = {
  id: "RequireTarget",
  targets: {
    [VAR_PLAY_CARD]: {
      id: "カード",
...
export const ACTION_CARD_TO_BASYOU: ActionMoveCardToPosition = {
  id: "ActionMoveCardToPosition",
  cards: {
    id: "カード",
    value: VAR_PLAY_CARD,
...
export const CARD_TEXT_PLAY: CardTextSiYouKaTa = {
  id: "使用型",
  timing: ["自軍", "配備フェイズ"],
  description: `プレイ`,
  block: {
