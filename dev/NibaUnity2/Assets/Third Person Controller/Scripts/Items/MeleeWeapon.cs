...
namespace Opsive.ThirdPersonController
{
    ...
    public class MeleeWeapon : Weapon, IHitboxItem
    {
        ...
        {
            Debug.Log("OnCollisionEnter:m_Controller:" + m_Controller);
            Debug.Log("OnCollisionEnter:m_InUse:" + m_InUse);
...
#endif
                Debug.Log("LayerMask:" + Utility.InLayerMask(collision.gameObject.layer, m_AttackLayer.value));
