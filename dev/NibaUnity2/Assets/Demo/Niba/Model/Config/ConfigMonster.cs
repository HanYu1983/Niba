...
case 2: return new ConfigMonster {ID="_unplan_"};
case 3: return new ConfigMonster {ID="bear",Name="熊",Terrian="forest",Str=40,Vit=30,Agi=8,Dex=13,Int=8,Luc=7,ActiveRate=5};
case 4: return new ConfigMonster {ID="bird",Name="鳥",Terrian="plain,forest",Str=15,Vit=5,Agi=30,Dex=30,Int=20,Luc=7,Characteristic="fly"};
case 5: return new ConfigMonster {ID="toxinSnack",Name="毒蛇",Terrian="forest",Str=16,Vit=8,Agi=15,Dex=15,Int=15,Luc=7,ActiveRate=100};
case 6: return new ConfigMonster {ID="bigBear",Name="大熊",Terrian="forest",Str=60,Vit=50,Agi=8,Dex=13,Int=8,Luc=7,ActiveRate=5};
