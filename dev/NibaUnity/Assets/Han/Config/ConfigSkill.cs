...
case 4: return new ConfigSkill {ID="tiauci",Name="調息",SkillTypeRequire="karate_20",Condition="turn",SlotCount=1,Effect="{0}+{1}",Values="hp,5%"};
...
case 9: return new ConfigSkill {ID="bokyoryokuhakai",Name="防禦力破壞",SkillTypeRequire="fencingArt_10",Condition="menu",SlotCount=1,Effect="對象防禦力下降{0}倍。",Values="0.1",Characteristic="enemy"};
...
case "tiauci": return new ConfigSkill {ID="tiauci",Name="調息",SkillTypeRequire="karate_20",Condition="turn",SlotCount=1,Effect="{0}+{1}",Values="hp,5%"};
...
case "bokyoryokuhakai": return new ConfigSkill {ID="bokyoryokuhakai",Name="防禦力破壞",SkillTypeRequire="fencingArt_10",Condition="menu",SlotCount=1,Effect="對象防禦力下降{0}倍。",Values="0.1",Characteristic="enemy"};
default: throw new Exception(key);
}}}