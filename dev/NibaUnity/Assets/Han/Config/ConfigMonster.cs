...
switch(key){
case 0: return new ConfigMonster {ID="ant",Name="螞蟻",Str=1,Vit=1,Agi=1,Dex=1,Int=1,Luc=1,Char="fly"};
...
case 3: return new ConfigMonster {ID="bear",Name="熊",Str=30,Vit=50,Agi=10,Dex=20,Int=0,Luc=0,Char="boss"};
default: throw new Exception(key+"");
}}public static ConfigMonster Get(string key){
switch(key){
case "ant": return new ConfigMonster {ID="ant",Name="螞蟻",Str=1,Vit=1,Agi=1,Dex=1,Int=1,Luc=1,Char="fly"};
...
case "bear": return new ConfigMonster {ID="bear",Name="熊",Str=30,Vit=50,Agi=10,Dex=20,Int=0,Luc=0,Char="boss"};
default: throw new Exception(key);
}}}