...
case 5: return new ConfigItem {ID="arrows",Name="箭矢",Type="resource",MaxCount=1,FusionRequire="feather,wood,gravel"};
...
case "arrows": return new ConfigItem {ID="arrows",Name="箭矢",Type="resource",MaxCount=1,FusionRequire="feather,wood,gravel"};
default: throw new Exception("");
}}}