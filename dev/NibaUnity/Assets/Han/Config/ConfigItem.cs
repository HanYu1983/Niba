...
case 2: return new ConfigItem {ID="gravel",Name="礫石",Type="material",SkillType="tailor",MaxCount=10};
case 3: return new ConfigItem {ID="feather",Name="羽毛",Type="material",SkillType="tailor",MaxCount=99};
case 4: return new ConfigItem {ID="bred",Name="木板",Type="material",SkillType="woodworker",MaxCount=10,FusionRequire="wood_2"};
case 5: return new ConfigItem {ID="iron",Name="鐵",Type="material",SkillType="ironworker",MaxCount=10};
...
case 7: return new ConfigItem {ID="woodShield",Name="木盾",Type="weapon",SkillType="shield",MaxCount=1,FusionRequire="wood_3",SkillRequire="woodworker_2",Ability="def+2",Position="hand",UseCount=10};
case 8: return new ConfigItem {ID="powerRing",Name="加量戒指",Type="weapon",SkillType="subtle",MaxCount=1,Ability="str+2",Position="accessory",UseCount=100};
...
case 10: return new ConfigItem {ID="ironShield",Name="鐵盾",Type="weapon",SkillType="shield",MaxCount=1,FusionRequire="iron_2",SkillRequire="ironworker_1",Ability="def+4",Position="hand",UseCount=15};
case 11: return new ConfigItem {ID="arrows",Name="木箭矢",Type="weapon",SkillType="subtle",MaxCount=99,FusionRequire="feather,wood,gravel",Ability="str+1",Position="hand",UseCount=0};
...
case 13: return new ConfigItem {ID="nightShield",Name="騎士盾",Type="weapon",SkillType="shield",MaxCount=1,FusionRequire="iron_4",Ability="def+8",Position="hand",UseCount=20};
...
case 16: return new ConfigItem {ID="woodHelmet",Name="木盔",Type="weapon",SkillType="armor",MaxCount=1,FusionRequire="wood_2",Ability="def+2",Position="head",UseCount=100};
case 17: return new ConfigItem {ID="woodArmor",Name="木甲",Type="weapon",SkillType="armor",MaxCount=1,FusionRequire="wood_2",Ability="def+4",Position="body",UseCount=100};
case 18: return new ConfigItem {ID="woodShoe",Name="木鞋",Type="weapon",SkillType="armor",MaxCount=1,FusionRequire="wood_2",Ability="def+1",Position="foot",UseCount=100};
...
case 22: return new ConfigItem {ID="buhuku",Name="布服",Type="weapon",SkillType="speed",MaxCount=1};
case 23: return new ConfigItem {ID="bumau",Name="布帽",Type="weapon",SkillType="speed",MaxCount=1};
case 24: return new ConfigItem {ID="piken",Name="皮製拳套",Type="weapon",SkillType="karate",MaxCount=1};
...
case "gravel": return new ConfigItem {ID="gravel",Name="礫石",Type="material",SkillType="tailor",MaxCount=10};
case "feather": return new ConfigItem {ID="feather",Name="羽毛",Type="material",SkillType="tailor",MaxCount=99};
case "bred": return new ConfigItem {ID="bred",Name="木板",Type="material",SkillType="woodworker",MaxCount=10,FusionRequire="wood_2"};
case "iron": return new ConfigItem {ID="iron",Name="鐵",Type="material",SkillType="ironworker",MaxCount=10};
...
case "woodShield": return new ConfigItem {ID="woodShield",Name="木盾",Type="weapon",SkillType="shield",MaxCount=1,FusionRequire="wood_3",SkillRequire="woodworker_2",Ability="def+2",Position="hand",UseCount=10};
case "powerRing": return new ConfigItem {ID="powerRing",Name="加量戒指",Type="weapon",SkillType="subtle",MaxCount=1,Ability="str+2",Position="accessory",UseCount=100};
...
case "ironShield": return new ConfigItem {ID="ironShield",Name="鐵盾",Type="weapon",SkillType="shield",MaxCount=1,FusionRequire="iron_2",SkillRequire="ironworker_1",Ability="def+4",Position="hand",UseCount=15};
case "arrows": return new ConfigItem {ID="arrows",Name="木箭矢",Type="weapon",SkillType="subtle",MaxCount=99,FusionRequire="feather,wood,gravel",Ability="str+1",Position="hand",UseCount=0};
...
case "nightShield": return new ConfigItem {ID="nightShield",Name="騎士盾",Type="weapon",SkillType="shield",MaxCount=1,FusionRequire="iron_4",Ability="def+8",Position="hand",UseCount=20};
...
case "woodHelmet": return new ConfigItem {ID="woodHelmet",Name="木盔",Type="weapon",SkillType="armor",MaxCount=1,FusionRequire="wood_2",Ability="def+2",Position="head",UseCount=100};
case "woodArmor": return new ConfigItem {ID="woodArmor",Name="木甲",Type="weapon",SkillType="armor",MaxCount=1,FusionRequire="wood_2",Ability="def+4",Position="body",UseCount=100};
case "woodShoe": return new ConfigItem {ID="woodShoe",Name="木鞋",Type="weapon",SkillType="armor",MaxCount=1,FusionRequire="wood_2",Ability="def+1",Position="foot",UseCount=100};
...
case "buhuku": return new ConfigItem {ID="buhuku",Name="布服",Type="weapon",SkillType="speed",MaxCount=1};
case "bumau": return new ConfigItem {ID="bumau",Name="布帽",Type="weapon",SkillType="speed",MaxCount=1};
case "piken": return new ConfigItem {ID="piken",Name="皮製拳套",Type="weapon",SkillType="karate",MaxCount=1};
default: throw new Exception(key);
}}}