...
case 9: return new ConfigAbility {ID="tailor",Dex=0.2f,Int=0.2f};
case 10: return new ConfigAbility {ID="woodworker",Str=0.1f,Vit=0.1f,Dex=0.1f,Int=0.1f};
case 11: return new ConfigAbility {ID="ironworker",Str=0.2f,Vit=0.2f};
case 12: return new ConfigAbility {ID="fencingArt",Str=0.3f,Agi=0.1f};
...
case 15: return new ConfigAbility {ID="armor",Str=0.1f,Vit=0.3f};
case 16: return new ConfigAbility {ID="speed",Agi=0.3f};
case 17: return new ConfigAbility {ID="move",Vit=0.05f,Agi=0.05f};
case 18: return new ConfigAbility {ID="subtle"};
...
case "tailor": return new ConfigAbility {ID="tailor",Dex=0.2f,Int=0.2f};
case "woodworker": return new ConfigAbility {ID="woodworker",Str=0.1f,Vit=0.1f,Dex=0.1f,Int=0.1f};
case "ironworker": return new ConfigAbility {ID="ironworker",Str=0.2f,Vit=0.2f};
case "fencingArt": return new ConfigAbility {ID="fencingArt",Str=0.3f,Agi=0.1f};
...
case "armor": return new ConfigAbility {ID="armor",Str=0.1f,Vit=0.3f};
case "speed": return new ConfigAbility {ID="speed",Agi=0.3f};
case "move": return new ConfigAbility {ID="move",Vit=0.05f,Agi=0.05f};
case "subtle": return new ConfigAbility {ID="subtle"};
default: throw new Exception(key);
}}}