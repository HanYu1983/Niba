...
declare global {
    export namespace IEditorEnv {
        ...
        export interface IAssetProcessor {
            ...
            onRecognizeJson?(headText: string): AssetType | string;
        }
        ...
        export interface IAssetManager {
            ...
            readonly packages: Readonly<Record<string, IPackageInfo>>;
        ...
        export interface FTypeDescriptor {
            ...
            /** 对Node和Component使用，当新建Node或者添加Component时，自动添加依赖的引擎库。例如：["laya.physics3D"] */
        ...
        export interface IUtils {
            ...
            readJson5(filePath: string): any;

            readJson5Async(filePath: string): Promise<any>;
