    ...
    texts: [
        {
            ...
            title: ["自動型", "恒常"],
            createPlayEffect: function _(ctx, effect, { DefineFn, GameStateFn }) {
                            ...
                            actions: [
                                {
                                    title: function _(ctx, effect, { DefineFn, GameStateFn, Options }) {
                                        ...
                                        ctx = GameStateFn.doItemMove(ctx, effect, DefineFn.AbsoluteBaSyouFn.setBaSyouKeyword(from, "プレイされているカード"), [cardId, from], { ges: Options.ges });
                                                        ...
                                                        actions: [
                                                            {
                                                                title: function _(ctx, effect, { DefineFn, GameStateFn, Options }) {
                                                                    ...
                                                                    ctx = GameStateFn.doItemMove(ctx, effect, DefineFn.AbsoluteBaSyouFn.of(cardController, "配備エリア"), GameStateFn.createStrBaSyouPair(ctx, cardId), { ges: Options.ges });
                                                                    ...
                                                                    for (const pair of unitPairs) {
                                                                        ...
                                                                        ctx = GameStateFn.doItemMove(ctx, effect, DefineFn.AbsoluteBaSyouFn.of(cardController, "配備エリア"), pair, { ges: Options.ges });
