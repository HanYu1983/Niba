                            ...
                            actions: [
                                {
                                    title: function _(ctx, effect, { DefineFn, GameStateFn, Options }) {
                                        ...
                                        ctx = GameStateFn.doItemMove(ctx, effect, DefineFn.AbsoluteBaSyouFn.of(cardController, "配備エリア"), targetPair, { ges: Options.ges });
                                        ctx = GameStateFn.doItemSetDestroy(ctx, effect, null, GameStateFn.createStrBaSyouPair(ctx, cardId), { ges: Options.ges });
                                        ctx = GameStateFn.doItemMoveBasic(ctx, DefineFn.AbsoluteBaSyouFn.of(cardController, "配備エリア"), GameStateFn.createStrBaSyouPair(ctx, cardId), { ges: Options.ges });
                                        ctx = GameStateFn.setSetGroupParent(ctx, targetPair[0], cardId);
                                        return ctx;
                                    }.toString()
                                }
                            ]
