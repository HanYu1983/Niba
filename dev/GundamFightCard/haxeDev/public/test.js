...
Test.main = function() {
	...
	model_ver1_game_alg_Runtime_test();
	console.log("src/Test.hx:9:","==== Test Pass ====");
};
...
function model_ver1_game_alg_Runtime_test() {
	console.log("src/model/ver1/game/alg/Runtime.hx:225:","abc");
}
