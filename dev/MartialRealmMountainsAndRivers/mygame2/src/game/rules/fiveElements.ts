...
/** 依相生循環排列的五元素：金 → 土 → 水 → 木 → 火 → 金。 */
export const FIVE_ELEMENTS: FiveElementMeta[] = [
  { key: 'metal', label: '金', icon: '⚜️', color: '#eab308', generates: 'earth', counters: 'wood' },
  { key: 'earth', label: '土', icon: '🏔️', color: '#fbbf24', generates: 'water', counters: 'water' },
  ...
  { key: 'fire', label: '火', icon: '🔥', color: '#f87171', generates: 'metal', counters: 'metal' },
]
