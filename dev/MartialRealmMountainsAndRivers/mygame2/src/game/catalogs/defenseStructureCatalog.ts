...
export const defenseStructureCatalog: DefenseStructureDefinition[] = [
  ...
  { type: 'strong-barricade', name: '堅壘', description: '木柵高級版，更堅固，大幅阻擋 Creature。', icon: '🧱', constructionCost: 50, requiredRank: 2, maxHealth: 120, healthBonus: 0, blocksMovement: true, providesVision: false, attackRange: 0, attackDamage: 0 },
  ...
  { type: 'supply-depot', name: '輜重庫', description: '於原位生成一座大型資源點，資源採集量 ×3。', icon: '📦', constructionCost: 120, requiredRank: 3, maxHealth: 160, healthBonus: 0, blocksMovement: false, providesVision: false, attackRange: 0, attackDamage: 0, resourceIncomeMultiplier: 3 },
  { type: 'warcamp-bastion', name: '軍壘', description: '強化 3 格內箭塔／瞭望塔，HP ×2、箭塔攻擊 ×2。', icon: '🏰', constructionCost: 150, requiredRank: 4, maxHealth: 100, healthBonus: 0, blocksMovement: false, providesVision: false, attackRange: 0, attackDamage: 0 },
  { type: 'warning-beacon', name: '烽燧臺', description: '每回合 50% 機率揭示全圖敵軍；剛建完立即揭示一次。', icon: '🔔', constructionCost: 100, requiredRank: 6, maxHealth: 140, healthBonus: 0, blocksMovement: false, providesVision: false, attackRange: 0, attackDamage: 0 },
  { type: 'bombard-cannon', name: '轟城砲', description: '遠距範圍砲擊，冷卻 2 回合。', icon: '🛢️', constructionCost: 200, requiredRank: 5, maxHealth: 180, healthBonus: 0, blocksMovement: false, providesVision: false, attackRange: 4, attackDamage: 35, cooldownRounds: 2 },
