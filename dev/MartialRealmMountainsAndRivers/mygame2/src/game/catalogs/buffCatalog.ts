...
export const buffCatalog: BuffDefinition[] = [
  ...
  // ── 門派內功常駐靈氣：依各門派取向分配 3 點五維 ──
  {
    id: 'golden-body-foundation',
    name: '金剛築基',
    description: '裝備金剛流內功期間，臂力 +2、根骨 +1。',
    duration: 'persistent',
    attributeModifiers: { armStrength: 2, constitution: 1 },
  },
  {
    id: 'swift-wind-foundation',
    name: '追風吐納',
    description: '裝備追風流內功期間，身法 +2、悟性 +1。',
    duration: 'persistent',
    attributeModifiers: { agility: 2, insight: 1 },
  },
  {
    id: 'scarlet-flame-foundation',
    name: '赤炎引氣',
    description: '裝備赤炎流內功期間，臂力 +2、內息 +1。',
    duration: 'persistent',
    attributeModifiers: { armStrength: 2, innerEnergy: 1 },
  },
  {
    id: 'frost-water-foundation',
    name: '寒水養氣',
    description: '裝備寒水流內功期間，內息 +2、根骨 +1。',
    duration: 'persistent',
    attributeModifiers: { innerEnergy: 2, constitution: 1 },
  },
  {
    id: 'earth-mountain-foundation',
    name: '厚土納元',
    description: '裝備厚土流內功期間，根骨 +2、內息 +1。',
    duration: 'persistent',
    attributeModifiers: { constitution: 2, innerEnergy: 1 },
  },
  {
    id: 'void-spirit-foundation',
    name: '太虛養神',
    description: '裝備太虛流內功期間，臂力 +1、根骨 +1、悟性 +1。',
    duration: 'persistent',
    attributeModifiers: { armStrength: 1, constitution: 1, insight: 1 },
  },
  {
    id: 'hundred-poison-foundation',
    name: '百毒納氣',
    description: '裝備百毒流內功期間，臂力 +2、身法 +1。',
    duration: 'persistent',
    attributeModifiers: { armStrength: 2, agility: 1 },
  },
  {
    id: 'sharp-edge-foundation',
    name: '銳鋒淬芒',
    description: '裝備銳鋒流內功期間，臂力 +2、身法 +1。',
    duration: 'persistent',
    attributeModifiers: { armStrength: 2, agility: 1 },
  },
  {
    id: 'misty-rain-foundation',
    name: '煙雨養元',
    description: '裝備煙雨流內功期間，內息 +2、悟性 +1。',
    duration: 'persistent',
    attributeModifiers: { innerEnergy: 2, insight: 1 },
  },
  {
    id: 'blazing-sun-foundation',
    name: '烈陽戰體',
    description: '裝備烈陽流內功期間，根骨 +2、臂力 +1。',
    duration: 'persistent',
    attributeModifiers: { constitution: 2, armStrength: 1 },
  },
  {
    id: 'yellow-earth-foundation',
    name: '黃土紮根',
    description: '裝備黃土流內功期間，根骨 +2、身法 +1。',
    duration: 'persistent',
    attributeModifiers: { constitution: 2, agility: 1 },
  },
  {
    id: 'ghost-shadow-foundation',
    name: '幽影藏形',
    description: '裝備幽影流內功期間，身法 +2、悟性 +1。',
    duration: 'persistent',
    attributeModifiers: { agility: 2, insight: 1 },
  },
  ...
  { id: 'earth-mountain-reflection', name: '反震', description: '受到傷害時反彈 15% 傷害。', duration: 'persistent', category: 'buff', reflectionPercent: 0.15, mapMarker: true, mapMarkerClass: 'earth-mountain' },
