...
| 價值函數元件寫入 `[AI decision]` 日誌 | ✅ 第一階段 | AI | — | 日誌含 goal context、selectedContext，以及建設/戰鬥/裝備/內功候選排名摘要 |
...
| M3：價值可解釋性 | `[AI decision]` 日誌含 goal context、selectedContext 與候選排名 | AI suite + console 檢查 | 第一階段完成 |
