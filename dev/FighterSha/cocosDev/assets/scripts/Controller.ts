...
import { Player, CardStack, AskCommandAnswer, Gameplay, AppView } from "./han/gameplay.types"
...
export default class Controller extends cc.Component {
    ...
    start() {
        ...
        const view: AppView = {
            ...
            AskOneCard: function (player: Player, cardStack: CardStack, cb: (ret: string | null) => void) {
            ...
            AskOption: function (player: Player, title: string, options: string[], cb: (ret: string | null) => void) {
                cb(null)
            },
