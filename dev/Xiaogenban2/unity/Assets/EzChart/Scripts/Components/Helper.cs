    ...
    public class Helper
    {
        ...
        public static Vector3 GetMousePosition(Canvas m_canvas)
        {
            ...
            else
            {
                ...
                screenPoint.z = m_canvas.planeDistance;
        ...
        public static void FindRange(bool zeroBased, int minDivision, float minValue, float maxValue, out float minRange, out float maxRange, out float stepSize, out int numberOfSteps)
        {
            if (minValue == 0.0f && maxValue == 0.0f) { minRange = 0.0f; maxRange = 1.0f; stepSize = 1.0f; numberOfSteps = 1; return; }
            ...
            minRange = minStep * stepSize;
            maxRange = maxStep * stepSize;
