...
class InspireJiCe implements IJiCe {
  ...
  public function buildPlayerMenu(actor:IPlayer):IPlayerMenu {
    ...
    var casterChoices:Array<MenuGeneralChoice> = JiCeMenuLegalChoices.eligibleCasters(ruler, registryKey(), StrategyCostTier.Medium);
  ...
  public function resolveChoice(actor:IPlayer, menuNode:IPlayerMenuNode):Void {
    ...
    if (!casterOk || !targetOk) {
      ...
      throw "InspireJiCe: invalid-choice (sig matched) — menu/widget mismatch";
    }
