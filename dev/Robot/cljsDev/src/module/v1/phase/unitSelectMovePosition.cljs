...
(core/defstate unitSelectMovePosition {unit :unit paths :paths}
  {:nameCtx gameplayCtx
   :initCtx nil
   :initState
   {:tempMoveRange (let [shortestPathTree (data/gameplayGetUnitMovePathTree nil gameplayCtx unit)
                         moveRange (map first shortestPathTree)]
                     moveRange)}
   :nameFsm _
   :nameState _
   :updateCtx (assoc gameplayCtx :moveRange (-> gameplayCtx :fsm tool.fsm/load :tempMoveRange))}
