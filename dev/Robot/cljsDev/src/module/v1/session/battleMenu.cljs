    ...
    (let [[actionType weapon] action
      ...
      (condp = actionType
        ...
        (-> ctx
            ...
            (update-in [0 :hitRate] (constantly (cond-> (data/getUnitHitRate gameplayCtx left weapon right)
    ...
    (let [[actionType weapon] action
      ...
      (condp = actionType
        ...
        (-> ctx
            ...
            (update-in [1 :hitRate] (constantly (cond-> (data/getUnitHitRate gameplayCtx right weapon left)
...
(defn setRightActionFromReaction [ctx gameplayCtx]
  (let [left (get-in ctx [0 :unit] ctx)
    ...
    (-> ctx
        (setRightAction (data/thinkReaction gameplayCtx right left leftWeapon) gameplayCtx)
        ; 更新左方數值
