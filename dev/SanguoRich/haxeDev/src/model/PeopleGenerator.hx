...
class PeopleGenerator {
    ...
    private var valuesName:Dynamic = {
        'command':'統率', 'force':'武力', 'intelligence':'智力', 'political':'政治', 'charm':'魅力'
    };
