			...
			switch ([g.landType, g.buildtype]) {
				...
				case [SHALLOW, CITY]:
					g.attachs = [
						...
						BUILDING.SIEGEFACTORY(0), BUILDING.ACADEMY(0), BUILDING.WALL(0), BUILDING.TREASURE(0), BUILDING.FISHING(0),
					];
				case [PLAIN, CITY]:
					g.attachs = [
						BUILDING.MARKET(0), BUILDING.BANK(1), BUILDING.FARM(0), BUILDING.BARN(1), BUILDING.BARRACKS(0), BUILDING.HOME(1), BUILDING.EXPLORE(0),
						BUILDING.SIEGEFACTORY(0), BUILDING.ACADEMY(0), BUILDING.WALL(0), BUILDING.TREASURE(0),
					];
				case [HILL, CITY]:
					g.attachs = [
						BUILDING.MARKET(0), BUILDING.BANK(1), BUILDING.FARM(0), BUILDING.BARN(1), BUILDING.BARRACKS(0), BUILDING.HOME(1), BUILDING.EXPLORE(0),
						BUILDING.SIEGEFACTORY(0), BUILDING.ACADEMY(0), BUILDING.WALL(0), BUILDING.TREASURE(0), BUILDING.MINE(0),
					];
				case [MOUNTAIN, CITY]:
					g.attachs = [
						BUILDING.MARKET(0), BUILDING.BANK(1), BUILDING.FARM(0), BUILDING.BARN(1), BUILDING.BARRACKS(0), BUILDING.HOME(1), BUILDING.EXPLORE(0),
						BUILDING.SIEGEFACTORY(0), BUILDING.ACADEMY(0), BUILDING.WALL(0), BUILDING.TREASURE(0), BUILDING.HUNTING(0),
					];
				case [_, EMPTY]:
					g.maxArmy = 0;
					g.maxFood = 0;
