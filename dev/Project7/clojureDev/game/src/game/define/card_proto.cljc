...
(defn test-all []
  ;(let [_ (s/explain ::spec (second card-proto-example))])
  (let [ctx {}
        runtime {}
        card-proto ["gundam"
                    {:texts {"gundam-text-1"
                     ...
                     :cost [:normal [:blue :blue nil nil nil]]
                     :pack :gundam}]
        _ (s/explain ::spec (second card-proto))
